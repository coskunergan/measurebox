...
/***************** PORT *******************/
#define SHT_SDA_GPIO  GPIOC
#define SHT_SDA_PIN   GPIO_Pin_9
#define SHT_SCL_GPIO  GPIOC
#define SHT_SCL_PIN	  GPIO_Pin_8
/**************** Control *****************/
#define Sda 	((SHT_SDA_GPIO->IDR & SHT_SDA_PIN)!=0x0)
#define SCL_LOW    SHT_SDA_GPIO->BSRRH = SHT_SCL_PIN
#define SCL_HIGH   SHT_SDA_GPIO->BSRRL = SHT_SCL_PIN
#define SDA_LOW   SHT_SCL_GPIO->BSRRH = SHT_SDA_PIN
#define SDA_HIGH  SHT_SCL_GPIO->BSRRL = SHT_SDA_PIN
/**************** define *****************/
#define Tamam	1
#define	Hata	0
...
{  
	uint16_t temp;
	uint32_t Timeout=80000; // 4 mhz için 480ms 
